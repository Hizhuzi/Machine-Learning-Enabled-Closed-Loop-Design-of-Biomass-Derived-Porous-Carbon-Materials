# -*- coding: utf-8 -*-
"""
Created on Sat Feb 18 04:23:35 2023
...
# Load datasets
df = pd.read_csv(r'./★☆imputation_data_upload.csv').drop(['No','VME'], axis=1)

# Draw distplot of uptake amount
plt.figure(figsize=(8, 8))
plt.xlabel('CO2 Uptake', fontsize=18)
plt.ylabel('Percentage', fontsize=18)
sns.distplot(df['VTT'], axlabel='VTT', label='cm^3')
plt.savefig('01 VTT Retrain F1 Distplot.png', dpi=300)
plt.show()

# Draw pairplot and heatmap
plt.figure(figsize=(8, 8))
sns.pairplot(df.drop(['VTT'], axis=1), palette='husl', plot_kws=dict(edgecolor=None))
...
for rs in [7, 14, 21, 35, 42, 84, 100, 120, 200, 420]:
    ...
    plt.scatter(y_test, y_pred_test, c='Tab:blue', alpha=0.6, edgecolors='none',
                label="Test (RMSE:{} R^2:{} MAE:{} MAPE:{})".format(df2.iloc[0, 1], df2.iloc[1, 1], df2.iloc[2, 1],
                                                                    df2.iloc[3, 1]))
    plt.plot([0, 3.5], [0, 3.5], c='orange', ls='--')
