...
# Read data
data = pd.read_excel("3D-synBDPCs.xlsx", usecols=[0, 1, 2, 9, 10, 11])
...
# Train the model
history = model.fit(X_train, y_train, epochs=1000, batch_size=32, verbose=1, class_weight=class_weight)
...
# Define function to print AUC scores
...
# Print AUC scores for training and test sets
...
cm_train = confusion_matrix(label_encoder.inverse_transform(np.argmax(y_train, axis=1)), y_pred_train_labels)
cm_test = confusion_matrix(label_encoder.inverse_transform(np.argmax(y_test, axis=1)), y_pred_test_labels)
...
display_labels=[r'$CO_2$', r'$FeCl_2$', r'$H_3PO_4$', r'$K_2CO_3$', r'$KOH$', r'$Li_2C_2O_4$', r'$LiCl-ZnCl_2$', r'$Na_2C_2O_4$', r'$NaNH_2$', r'$NO$', r'$ZnCl_2$']  # Use TeX formatted labels

disp_train.plot(cmap=plt.cm.YlOrBr)
plt.xticks(rotation=60) # Rotate x-axis ticks by 60 degrees    


disp_test = ConfusionMatrixDisplay(confusion_matrix=cm_test_norm, display_labels=label_encoder.classes_)
display_labels=[r'$CO_2$', r'$FeCl_2$', r'$H_3PO_4$', r'$K_2CO_3$', r'$KOH$', r'$Li_2C_2O_4$', r'$LiCl-ZnCl_2$', r'$Na_2C_2O_4$', r'$NaNH_2$', r'$NO$', r'$ZnCl_2$']  # Use TeX formatted labels

disp_test.plot(cmap=plt.cm.YlOrBr)
plt.xticks(rotation=60) # Rotate x-axis ticks by 60 degrees